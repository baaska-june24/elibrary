...
import CreateSeries from "~/components/Dashboard/Series/CreateSeries";
import UpdateSeries from "~/components/Dashboard/Series/UpdateSeries";
      ...
      <Row style={{ marginBottom: "20px" }}>
        <Col md={16}>
          <Button bordered onClick={() => setVisible(true)}>
            <Icon type="cloud-upload" /> Цуврал үүсгэх
          </Button>
        </Col>
        <Col md={8}>
          <Input.Search
